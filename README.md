...
NagroMS is a digital platform designed to connect farmers, retail shops, and direct customers through a centralized system.
Our goal is to reduce farmers' dependency on middle vendors and improve fair market access using modern web technologies.
...
Frontend: User Interface for Farmers, Retailers, Customers

Backend: Handles business logic and API services

Database: Stores user data, product data, transactions, etc.
