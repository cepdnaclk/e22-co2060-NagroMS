...
export default function SettingsSection() {
  ...
  return (
    <div className="nagro-section-content" style={{ paddingBottom: '60px' }}>
      <h2 style={{ fontSize: '24px', fontWeight: 600, color: '#111827', marginBottom: '24px' }}>{t('farmer.settings.title') || 'Settings'}</h2>
      ...
      <form onSubmit={handleSave} style={{ display: 'grid', gap: '24px', gridTemplateColumns: '1fr', maxWidth: '800px' }}>
        ...
        <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#1f2937', marginBottom: '16px', borderBottom: '1px solid #e5e7eb', paddingBottom: '8px' }}>{t('farmer.settings.personalInfo') || 'Personal Information'}</h3>
          ...
          <div style={{ display: 'flex', gap: '16px', alignItems: 'center', marginBottom: '24px' }}>
            <div style={{ width: '80px', height: '80px', borderRadius: '50%', backgroundColor: '#f3f4f6', overflow: 'hidden', border: '1px solid #d1d5db', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              {photoFile ? (
                ...
                <span style={{ color: '#9ca3af', fontSize: '12px' }}>{t('farmer.settings.noPhoto') || 'No Photo'}</span>
              )}
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.profilePhoto') || 'Profile Photo'}</label>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.fullName') || 'Full Name'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.nic') || 'NIC Number'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.dob') || 'Date of Birth'}</label>
              <input type="text" placeholder={t("farmer.settings.dobPlaceholder") || "MM/DD/YYYY"} name="dateOfBirth" value={formData.dateOfBirth} onChange={handleChange} style={{ width: '100%', padding: '8px 12px', borderRadius: '6px', border: '1px solid #d1d5db', outline: 'none' }} />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.gender') || 'Gender'}</label>
              <select name="gender" value={formData.gender} onChange={handleChange} style={{ width: '100%', padding: '8px 12px', borderRadius: '6px', border: '1px solid #d1d5db', outline: 'none' }}>
                <option value="">{t('farmer.settings.selectGender') || 'Select Gender'}</option>
                <option value="Male">{t('farmer.settings.male') || 'Male'}</option>
                <option value="Female">{t('farmer.settings.female') || 'Female'}</option>
                <option value="Other">{t('farmer.settings.other') || 'Other'}</option>
              </select>
            </div>
            <div>
        ...
        {/* Contact Information */}
        <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#1f2937', marginBottom: '16px', borderBottom: '1px solid #e5e7eb', paddingBottom: '8px' }}>{t('farmer.settings.contactDetails') || 'Contact Details'}</h3>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.phone') || 'Phone Number'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.whatsapp') || 'WhatsApp Number'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.email') || 'Email'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.village') || 'Village / Town'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.district') || 'District'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.postalCode') || 'Postal Code'}</label>
        ...
        <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', borderBottom: '1px solid #e5e7eb', paddingBottom: '8px' }}>
            <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#1f2937', margin: 0 }}>{t('farmer.settings.paymentDetails') || 'Payment Details'}</h3>
            <button type="button" onClick={handleEditPaymentClick} style={{ padding: '6px 12px', borderRadius: '6px', backgroundColor: isPaymentEditable ? '#f3f4f6' : '#dcfce7', color: isPaymentEditable ? '#374151' : '#16a34a', border: isPaymentEditable ? '1px solid #d1d5db' : 'none', cursor: 'pointer', fontWeight: 600, fontSize: '12px' }}>
              {isPaymentEditable ? (t('farmer.settings.cancelEdit') || 'Cancel Edit') : (t('farmer.settings.editPayment') || 'Edit Payment Details')}
            </button>
          </div>
          <p style={{ fontSize: '13px', color: '#6b7280', marginBottom: '16px' }}>{isPaymentEditable ? t('farmer.settings.paymentUnlockMsg') || 'You can now edit your payment details.' : t('farmer.settings.paymentLockMsg') || 'Payment details are locked for your security. Click "Edit Payment Details" to verify via SMS.'}</p>
          
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', opacity: isPaymentEditable ? 1 : 0.6 }}>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.prefMethod') || 'Preferred Payment Method'}</label>
              <select name="pay_preferredPaymentMethod" disabled={!isPaymentEditable} value={formData.paymentDetails.preferredPaymentMethod} onChange={handleChange} style={{ width: '100%', padding: '8px 12px', borderRadius: '6px', border: '1px solid #d1d5db', outline: 'none', backgroundColor: isPaymentEditable ? 'white' : '#f9fafb' }}>
                <option value="">{t('farmer.settings.selectMethod') || 'Select Method'}</option>
                <option value="Bank Transfer">{t('farmer.settings.bankTransfer') || 'Bank Transfer'}</option>
                <option value="Cash">{t('farmer.settings.cash') || 'Cash'}</option>
              </select>
            </div>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.bankName') || 'Bank Name'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.accName') || 'Account Holder Name'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.accNumber') || 'Account Number'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.branch') || 'Branch'}</label>
        ...
        {/* Notifications */}
        <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
          <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#1f2937', marginBottom: '16px', borderBottom: '1px solid #e5e7eb', paddingBottom: '8px' }}>{t('farmer.settings.notifications') || 'Notifications'}</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {Object.keys(formData.notifications).map(key => (
              <label key={key} style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', color: '#374151', cursor: 'pointer' }}>
                ...
                {t('farmer.settings.' + key) || key.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase())}
              </label>
            ))}
          </div>
        </div>
        ...
        <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '12px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', borderBottom: '1px solid #e5e7eb', paddingBottom: '8px' }}>
            <h3 style={{ fontSize: '18px', fontWeight: 600, color: '#1f2937', margin: 0 }}>{t('farmer.settings.changePassword') || 'Change Password'}</h3>
            <button type="button" onClick={handleEditPasswordClick} style={{ padding: '6px 12px', borderRadius: '6px', backgroundColor: isPasswordEditable ? '#f3f4f6' : '#dcfce7', color: isPasswordEditable ? '#374151' : '#16a34a', border: isPasswordEditable ? '1px solid #d1d5db' : 'none', cursor: 'pointer', fontWeight: 600, fontSize: '12px' }}>
              {isPasswordEditable ? (t('farmer.settings.cancelEdit') || 'Cancel Edit') : (t('farmer.settings.editPassword') || 'Edit Password')}
            </button>
          </div>
          <p style={{ fontSize: '13px', color: '#6b7280', marginBottom: '16px' }}>{isPasswordEditable ? t('farmer.settings.passUnlockMsg') || 'You can now change your password. Leave empty if you do not want to change it.' : t('farmer.settings.passLockMsg') || 'Password fields are locked for your security. Click "Edit Password" to verify via SMS.'}</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', opacity: isPasswordEditable ? 1 : 0.6 }}>
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.newPassword') || 'New Password'}</label>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '14px', fontWeight: 500, color: '#374151', marginBottom: '4px' }}>{t('farmer.settings.confirmPassword') || 'Confirm New Password'}</label>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '16px', marginTop: '16px' }}>
          <button type="submit" disabled={loading} style={{ padding: '12px 24px', borderRadius: '6px', backgroundColor: '#16a34a', color: 'white', border: 'none', cursor: 'pointer', fontWeight: 600, fontSize: '16px', minWidth: '150px' }}>
            {loading ? t('farmer.settings.saving') : t('farmer.settings.saveChanges')}
          </button>
        </div>
        ...
        <div style={{ borderTop: '1px solid #e5e7eb', marginTop: '32px', paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <button type="button" onClick={handleLogout} style={{ padding: '10px 20px', borderRadius: '6px', backgroundColor: '#f3f4f6', color: '#374151', border: '1px solid #d1d5db', cursor: 'pointer', fontWeight: 600 }}>{t('farmer.settings.logout') || 'Logout'}</button>
          
          <button type="button" onClick={handleDeleteAccount} style={{ padding: '10px 20px', borderRadius: '6px', backgroundColor: '#fee2e2', color: '#dc2626', border: 'none', cursor: 'pointer', fontWeight: 600 }}>{t('farmer.settings.deleteAccount') || 'Delete Account'}</button>
        </div>
      </form>
      ...
      {showOtpModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          <div style={{ backgroundColor: 'white', padding: '32px', borderRadius: '12px', width: '100%', maxWidth: '400px' }}>
            <h2 style={{ fontSize: '20px', fontWeight: 600, marginBottom: '16px', color: '#111827' }}>{t('farmer.settings.verifyIdentity') || 'Verify Identity'}</h2>
            ...
            <div style={{ marginBottom: '24px' }}>
              <input type="text" placeholder={t('farmer.settings.enterOtp') || 'Enter OTP (e.g. 123456)'} value={otpInput} onChange={e => setOtpInput(e.target.value)} style={{ width: '100%', padding: '12px', borderRadius: '6px', border: '1px solid #d1d5db', outline: 'none', textAlign: 'center', fontSize: '18px', letterSpacing: '4px' }} />
            </div>
            <div style={{ display: 'flex', gap: '12px' }}>
              <button type="button" onClick={() => { setShowOtpModal(false); setOtpInput(''); setOtpTarget(''); }} style={{ flex: 1, padding: '10px', backgroundColor: 'white', border: '1px solid #d1d5db', borderRadius: '8px', cursor: 'pointer', fontWeight: 500 }}>{t('farmer.settings.cancel') || 'Cancel'}</button>
              <button type="button" onClick={handleVerifyOtp} style={{ flex: 1, padding: '10px', backgroundColor: '#16a34a', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 600 }}>{t('farmer.settings.verify') || 'Verify'}</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showDeleteModal && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          <div style={{ backgroundColor: 'white', padding: '32px', borderRadius: '12px', width: '100%', maxWidth: '400px' }}>
            <h2 style={{ fontSize: '20px', fontWeight: 600, marginBottom: '16px', color: '#dc2626' }}>{t('farmer.settings.deleteAccount') || 'Delete Account'}</h2>
            <p style={{ color: '#4b5563', fontSize: '14px', marginBottom: '24px', lineHeight: '1.5' }}>
              Are you sure you want to delete your account? This action cannot be undone. All your farm data will be permanently removed.
            </p>
            <div style={{ display: 'flex', gap: '12px' }}>
              <button onClick={() => setShowDeleteModal(false)} style={{ flex: 1, padding: '10px', backgroundColor: 'white', border: '1px solid #d1d5db', borderRadius: '8px', cursor: 'pointer', fontWeight: 500 }}>{t('farmer.settings.cancel') || 'Cancel'}</button>
              <button onClick={confirmDelete} style={{ flex: 1, padding: '10px', backgroundColor: '#dc2626', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 600 }}>{t('farmer.settings.confirmDel') || 'Confirm Delete'}</button>
            </div>
          </div>
        </div>
      )}
