...
import {
    ...
    Package, ShieldCheck, MapPin, Info, Send, Paperclip, Filter, Menu
} from 'lucide-react';
import {
    ...
    return (
        <div className="mobile-dash-wrapper" style={{ display: 'flex', background: ds.bg, minHeight: '100vh', width: '100%', fontVariantNumeric: 'tabular-nums' }}>
            ...
            <button 
                ...
                style={{ position: 'absolute', top: 16, left: 16, zIndex: 100, background: ds.green, color: '#fff', border: 'none', borderRadius: 8, padding: 8, cursor: 'pointer' }}
            >
