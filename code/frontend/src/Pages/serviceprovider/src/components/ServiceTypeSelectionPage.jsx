...
export function ServiceTypeSelectionPage({ onNavigate }) {
                            ...
                            >
                                ...
                                {isSelected && (
                                    <div style={{
                                        ...
                                        background: `linear-gradient(135deg, ${st.color}, ${st.color}dd)`, display: 'flex', alignItems: 'center', justify: 'center',
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                                    {st.features.map((f, i) => (
                                        <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5rem', fontSize: '0.85rem', color: '#334155', fontFamily: "'Inter', sans-serif" }}>
                                            <div style={{ width: 18, height: 18, borderRadius: '50%', background: `${st.color}25`, display: 'flex', alignItems: 'center', justify: 'center', flexShrink: 0, marginTop: 1 }}>
