  ...
  en: {
    farmer: {
      ...
      overview: {
        ...
        incomingOrders: 'Incoming Orders', noOrders: 'No incoming orders yet.', quantitySold: 'Quantity Sold',
      ...
      management: {
        ...
        pesticide: 'Pesticide',
        equipment: 'Equipment',
        waterElec: 'Water / Electricity',
        packaging: 'Packaging',
        other: 'Other',
        productSale: 'Product Sale',
        directCustomer: 'Direct Customer Sale',
        wholesale: 'Wholesale Sale',
        deliveryIncome: 'Delivery Income',
        farmingService: 'Farming Service',
  ...
  si: {
    farmer: {
      ...
      overview: {
        ...
        incomingOrders: 'ලැබෙන ඇණවුම්', noOrders: 'තවමත් ඇණවුම් නොමැත.', quantitySold: 'විකිණූ ප්‍රමාණය',
      ...
      management: {
        ...
        equipment: 'උපකරණ',
        waterElec: 'ජලය / විදුලිය',
        packaging: 'ඇසුරුම්',
        other: 'වෙනත්',
        productSale: 'නිෂ්පාදන අලෙවිය',
        directCustomer: 'සෘජු පාරිභෝගික අලෙවිය',
        wholesale: 'තොග අලෙවිය',
        deliveryIncome: 'බෙදාහැරීමේ ආදායම',
        farmingService: 'ගොවිපල සේවාව',
        govSupport: 'රජයේ සහනාධාර'
      },
      services: {
  ...
  ta: {
    farmer: {
      ...
      overview: {
        ...
        incomingOrders: 'வரும் ஆர்டர்கள்', noOrders: 'இன்னும் ஆர்டர்கள் வரவில்லை.', quantitySold: 'விற்கப்பட்ட அளவு',
      ...
      management: {
        ...
        packaging: 'பொதியிடல்',
        other: 'மற்றவை',
        productSale: 'தயாரிப்பு விற்பனை',
        directCustomer: 'நேரடி வாடிக்கையாளர் விற்பனை',
        wholesale: 'மொத்த விற்பனை',
        deliveryIncome: 'விநியோக வருமானம்',
        farmingService: 'விவசாய சேவை',
